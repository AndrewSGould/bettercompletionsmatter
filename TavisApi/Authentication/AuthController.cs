...
public class AuthV2Controller : ControllerBase {
	...
	public AuthV2Controller(TavisContext context, ITokenServiceV2 tokenService, IOpenXblServiceV2 oxblService,
	IDiscordServiceV2 discordService, IUserServiceV2 userService)
	{

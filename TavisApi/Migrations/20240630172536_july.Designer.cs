...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tavis.Models.FebRecap", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Tavis.Models.JanRecap", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Tavis.Models.MayRecap", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TavisApi.Models.AprRecap", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TavisApi.Models.JulyRecap", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TavisApi.Models.JunRecap", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TavisApi.Models.MonthlyExclusion", b =>
                {
                    b.Property<int?>("GameId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tavis.Models.FebRecap", b =>
                {
                    b.HasOne("Tavis.Models.BcmPlayer", "BcmPlayer")
                        .WithOne("FebRecap")
                        .HasForeignKey("Tavis.Models.FebRecap", "PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Tavis.Models.JanRecap", b =>
                {
                    b.HasOne("Tavis.Models.BcmPlayer", "BcmPlayer")
                        .WithOne("JanRecap")
                        .HasForeignKey("Tavis.Models.JanRecap", "PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Tavis.Models.MayRecap", b =>
                {
                    b.HasOne("Tavis.Models.BcmPlayer", "BcmPlayer")
                        .WithOne("MayRecap")
                        .HasForeignKey("Tavis.Models.MayRecap", "PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TavisApi.Models.AprRecap", b =>
                {
                    b.HasOne("Tavis.Models.BcmPlayer", "BcmPlayer")
                        .WithOne("AprRecap")
                        .HasForeignKey("TavisApi.Models.AprRecap", "PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TavisApi.Models.JulyRecap", b =>
                {
                    b.HasOne("Tavis.Models.BcmPlayer", "BcmPlayer")
                        .WithOne("JulyRecap")
                        .HasForeignKey("TavisApi.Models.JulyRecap", "PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TavisApi.Models.JunRecap", b =>
                {
                    b.HasOne("Tavis.Models.BcmPlayer", "BcmPlayer")
                        .WithOne("JunRecap")
                        .HasForeignKey("TavisApi.Models.JunRecap", "PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

...
[ApiController]
[Route("/v2/ta/sync")]
public class TA_SyncController : ControllerBase {
	private TavisContext _context;
	private readonly IParser _parser;
	private readonly IDataSync _dataSync;
	private readonly IHubContext<SyncSignal> _hub;

	public TA_SyncController(TavisContext context, IParser parser, IDataSync dataSync, IHubContext<SyncSignal> hub)
	{
		_context = context;
		_parser = parser;
		_dataSync = dataSync;
	...
	{
		// TODO: get players to scan
		var playersToScan = new List<int>();
	...
	public IActionResult SyncGameInfo()
	{
		...
		var games = _context.PlayerGames.Include(x => x.Game);
